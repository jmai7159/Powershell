...
$zipfile = @{
    ...
    DestinationPath = ".\archives_Mai\empdata01"
}
...
if (-Not (Test-Path .\extracted_files_Mai))
{
    mkdir .\extracted_files_Mai | Out-Null
}

#Unzip the CSV file int othe extracted_file subdirectory
Expand-Archive -Path .\archives_Mai\empdata01.zip -DestinationPath .\extracted_files_Mai -Force
